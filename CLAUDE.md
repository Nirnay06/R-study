...
4. Silently commit+push the `exports/` PDF (see Riya rule 3), then share the direct link in chat:
   `https://raw.githubusercontent.com/Nirnay06/R-study/main/exports/<File-Name>.pdf`
   Filenames: hyphens only, no spaces. Never commit HTML intermediates.
...
| `memory/tribal_pyq_building_blocks.md` | PYQ Building Blocks — 20 modular answer blocks mapped to PYQ themes (2014–2024), frequency analysis, cross-cutting templates, scholar toolkit | Paper 2 (Units 6.1–9.3) | PYQ Booklet + All tribal memory files |
